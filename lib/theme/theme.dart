...
BorderRadius GlobalBorderRadius = BorderRadius.all(
  Radius.circular(rad as double),
);
...
BorderRadius SecondaryBorderRadius = BorderRadius.all(
  Radius.circular(Srad as double),
);
...
class rotating_container extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Transform(
      ...
      transform: Matrix4.identity()..rotateZ(rotationZ * 3.1415927 / 180),
      child: Container(
...
class tablet_containerStyle {
  ...
  static EdgeInsets marginCol2 = const EdgeInsets.only(
    top: 16,
    left: 16,
    right: 16,
  );
...
class containerStyle {
  ...
  static EdgeInsets padding = const EdgeInsets.all(16);
  static EdgeInsets paddingNew = const EdgeInsets.only(
    top: 16,
    left: 16,
    right: 16,
    bottom: 0.5,
  ...
  //mobile property
  static EdgeInsets margin_mobile = const EdgeInsets.only(
    top: 10,
    left: 10,
    right: 5,
  );
...
class ContactMe_containerStyle_mobile {
  static EdgeInsets margin = const EdgeInsets.only(top: 10);
  static BorderRadius borderRadius = GlobalBorderRadius;
  static EdgeInsets padding = const EdgeInsets.all(16);
  static Color color = GlobalColor;
